...
# ⚡ Bolt: Moved glob and ThreadPoolExecutor to lazy loading
# ⚡ Bolt: Moved load_dotenv to _ensure_dotenv
...
class JudgeGuard:
    ...
    # ⚡ Bolt: Hoisted keyword constants for efficient hot-path checks
    ...
    def __init__(self, brain_path: Optional[str] = None, work_log_path: Optional[str] = None):
        ...
        # ⚡ Bolt: mtime-based cache for work log retrieval
        self._log_cache = {"mtime": 0, "content": "", "max_chars": 0}

        logger.info("JudgeGuard v2.0 initialized (Lazy).")

    @property
    def brain_path(self) -> Optional[str]:
        """⚡ Bolt: Lazy-load brain_path discovery."""
    ...
    def work_log_path(self) -> str:
        """⚡ Bolt: Lazy-load work_log_path discovery."""
    ...
    def rules_path(self) -> str:
        """⚡ Bolt: Lazy-load rules_path resolution."""
    ...
    def immutable_laws(self) -> str:
        """⚡ Bolt: Lazy-load immutable laws from file."""
    ...
    def _get_log_context(self, max_chars: int = 15000) -> str:
        """⚡ Bolt: mtime-cached O(1) tail retrieval of work log."""
        ...
        try:
            ...
            if (self._log_cache["mtime"] == mtime and
                self._log_cache["max_chars"] >= max_chars):
    ...
    def _load_context(self, max_chars: int = 15000) -> str:
        """Legacy wrapper for _get_log_context."""
    ...
    def _is_dangerous_command(self, action: str) -> bool:
        ...
        Parameters:
            action (str): Text of the action to inspect. Assumed to be lower-cased.
    ...
    def _is_write_operation(self, action: str) -> bool:
        ...
        Parameters:
		action (str): Freeform action description to inspect. Assumed to be lower-cased.
    ...
    def _check_work_log(self, action_lower: str) -> bool:
        ...
        try:
            # ⚡ Bolt: Reuse cached log content if available
    ...
    def verify_action(self, current_action: str) -> bool:
        ...
        """
        # ⚡ Bolt: Normalize action string once for all hot-path checks
