...
# Initialize a placeholder logger until _ensure_setup is called
logger = logging.getLogger(__name__)
...
class JudgeGuard:
    ...
    def __init__(self, brain_path: Optional[str] = None, work_log_path: Optional[str] = None):
        ...
        # ⚡ Bolt: Use lazy properties for path discovery and rule loading
        ...
        # ⚡ Bolt: Log initialization lazily to avoid triggering setup early
    ...
    @property
    def rules_path(self):
        """⚡ Bolt: Lazy initialization of rules path."""
    ...
    def _is_write_operation(self, action_lower: str) -> bool:
        ...
        Returns:
            True if it indicates a write/edit operation, False otherwise.
        """
