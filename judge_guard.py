...
class JudgeGuard:
    ...
    def __init__(self, brain_path: Optional[str] = None, work_log_path: Optional[str] = None):
        # ⚡ Bolt: Store arguments and defer all I/O and heavy imports
    ...
    @property
    def logger(self):
        """⚡ Bolt: Lazy-load logger to avoid early logging configuration."""
    ...
    def _ensure_setup(self):
        """⚡ Bolt: Deferred environment setup and logging configuration."""
        if not self._setup_done:
            with self._lock:
                if not self._setup_done:
                    ...
                    self.logger.info("JudgeGuard v2.0 environment initialized.")
    ...
    def close(self):
        """⚡ Bolt: Ensure resources are cleanly shut down if they were initialized."""
    ...
    def _detect_phase(self, context: str) -> str:
        """Detects the project phase from context."""
    ...
    def _is_write_operation(self, action: str) -> bool:
        """Check for write/edit-related keywords."""
    ...
    def _sync_to_notion(self, action: str):
        ...
        try:
            # ⚡ Bolt: Offload to background executor
        ...
        try:
            ...
            with open(self.work_log_path, 'rb') as f:
                ...
                if '🟡' in last_lines or 'starting' in last_lines:
                    ...
                    self.logger.warning("WORK_LOG.md missing '🟡' indicator in last 1000 chars.")
