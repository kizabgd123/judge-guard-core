...
def _ensure_dotenv():
    """⚡ Bolt: Thread-safe lazy load of .env variables."""
...
def _ensure_logging():
    """⚡ Bolt: Defer logging configuration until needed."""
...
class JudgeGuard:
    ...
    # ⚡ Bolt: Class-level constants to avoid redundant lookups in hot path
    ...
    def _is_write_operation(self, action_lower: str) -> bool:
        ...
        Parameters:
		action_lower (str): Lower-cased action description to inspect for write/edit-related keywords.
    ...
    def verify_action(self, current_action: str) -> bool:
        ...
        """
        # ⚡ Bolt: Computed once and passed down to avoid redundant lower() calls
