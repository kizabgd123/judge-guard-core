...
class JudgeGuard:
    ...
    def close(self):
        ...
        # ⚡ Bolt: wait=True to ensure background cache/sync tasks complete before close
    ...
    def verify_action(self, current_action: str) -> bool:
        ...
        if passed:
            ...
            # ⚡ Bolt: Offload verdict caching to background thread to reduce cold-path latency
            if self.pipeline:
