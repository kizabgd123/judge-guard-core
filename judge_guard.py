...
# ⚡ Bolt: Defer load_dotenv and other heavy imports to properties/methods
# to reduce CLI startup latency for high-frequency verification.
...
class JudgeGuard:
    ...
    def __init__(self, brain_path: Optional[str] = None, work_log_path: Optional[str] = None):
        # ⚡ Bolt: Use RLock for thread-safe lazy property initialization
    ...
    @property
    def brain_path(self):
        """⚡ Bolt: Thread-safe lazy discovery of brain path."""
    ...
    def work_log_path(self):
        """⚡ Bolt: Thread-safe lazy discovery of work log path."""
    ...
    @property
    def rules_path(self):
        """⚡ Bolt: Thread-safe lazy initialization of rules path."""
    ...
    def immutable_laws(self):
        """⚡ Bolt: Thread-safe lazy loading of immutable laws from disk."""
    ...
    @property
    def executor(self):
        """⚡ Bolt: Thread-safe lazy initialization of background executor."""
    ...
    def _is_write_operation(self, action_lower: str) -> bool:
        ...
        Parameters:
		action_lower (str): Lower-cased freeform action description to inspect.
        
        Returns:
		True if the description contains write-related keywords, False otherwise.
        """
