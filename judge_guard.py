...
class JudgeGuard:
    ...
    def __init__(self, brain_path: Optional[str] = None, work_log_path: Optional[str] = None):
        # ⚡ Bolt: Attributes initialized lazily to reduce startup overhead
        ...
        # ⚡ Bolt: rules_path is lightweight, but we still ensure dotenv is ready
        _ensure_dotenv()
        self.rules_path = os.getenv("MASTER_RULES_PATH") or os.path.expanduser("~/.gemini/MASTER_ORCHESTRATION.md")

        logger.info(f"JudgeGuard v2.0 initialized (Lazy).")
