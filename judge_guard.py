...
class JudgeGuard:
    ...
    def __init__(self, brain_path: Optional[str] = None, work_log_path: Optional[str] = None):
        ...
        # ⚡ Bolt: Removed logger.info here to avoid triggering early brain_path discovery.

    @property
    def brain_path(self) -> Optional[str]:
        """⚡ Bolt: Lazy-load brain path only when needed."""
    ...
    def immutable_laws(self) -> str:
        """⚡ Bolt: Lazy-load immutable laws (master orchestration rules) on demand."""
