...
class JudgeGuard:
    ...
    def __init__(self, brain_path: Optional[str] = None, work_log_path: Optional[str] = None):
        ...
        self._gemini = None
        self._pipeline = None
        # ⚡ Bolt: Attributes refactored to lazy properties to minimize __init__ I/O.

    def _ensure_setup(self):
        """⚡ Bolt: Lazy-load environment variables and logging."""
    ...
    @property
    def logger(self):
        """⚡ Bolt: Lazy-load logging to avoid overhead during CLI startup."""
        if not hasattr(self, "_logger_instance"):
            import logging
            self._ensure_setup()
            # basicConfig is only effective on first call
    ...
    @property
    def brain_path(self):
        """⚡ Bolt: Discovery of brain path is now deferred until needed."""
    ...
    def work_log_path(self):
        """⚡ Bolt: Discovery of work log path is now deferred until needed."""
    ...
    @property
    def rules_path(self):
        """⚡ Bolt: Master Orchestration path calculation is deferred."""
    ...
    def immutable_laws(self):
        """⚡ Bolt: Reading rules file is now deferred (avoids 100KB read on cache hits)."""
