...
class JudgeGuard:
    ...
    # ⚡ Bolt: Class-level constants for O(1) attribute access vs O(N) list instantiation
    ...
    @property
    def brain_path(self):
        """⚡ Bolt: Lazy-load brain path to avoid globbing on startup."""
    ...
    def work_log_path(self):
        """⚡ Bolt: Lazy-load work log path to avoid disk discovery on startup."""
    ...
    def immutable_laws(self):
        """⚡ Bolt: Lazy-load rules to avoid disk I/O on startup."""
    ...
    def verify_action(self, current_action: str) -> bool:
        ...
        """
        # ⚡ Bolt: Lowercase once for all checks
