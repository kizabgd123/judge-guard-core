...
# ⚡ Bolt: Reduced module-level logging and deferred heavy imports
...
class JudgeGuard:
    ...
    # ⚡ Bolt: Class-level constants for efficient hot-path keyword checks
    ...
    def __init__(self, brain_path: Optional[str] = None, work_log_path: Optional[str] = None):
        # ⚡ Bolt: Lazy initialization with RLock to prevent deadlocks and race conditions
    ...
    def verify_action(self, current_action: str) -> bool:
        ...
        """
        # ⚡ Bolt: Normalize action string once for all downstream checks
