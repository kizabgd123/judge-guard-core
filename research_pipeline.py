...
class ResearchPipeline:
    def __init__(self):
        ...
        self._verdict_cache = {}
        # ⚡ Bolt: Thread-safe lazy executor to defer ThreadPoolExecutor instantiation
        self._executor = None
    ...
    def get_cached_verdict(self, action: str) -> Optional[str]:
        ...
        # ⚡ Bolt: Store verdict in memory cache (including None for cache misses) to speed up repeat lookups
        self._verdict_cache[action_hash] = verdict
        return verdict
