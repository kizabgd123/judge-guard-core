...
# === CONFIG ===
# ⚡ Bolt: Using strings and lazy getters to defer pathlib overhead
...
# ⚡ Bolt: Pre-compiled regex holder (lazily initialized)
PATTERN_RE = None
...
class ResearchPipeline:
    ...
    @property
    def executor(self):
        """⚡ Bolt: Lazy-load ThreadPoolExecutor for parallelizing Notion API calls."""
