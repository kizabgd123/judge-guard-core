...
# === CONFIG ===
# ⚡ Bolt: Use strings for paths to minimize module-load overhead
DB_PATH = "./research.db"
RESEARCH_DIR = "./research"
NOTION_LOG = "./.cache/notion_queue.json"

# ⚡ Bolt: Pre-compiled regex holder (lazy)
_PATTERN_RE = None
...
class ResearchPipeline:
    ...
    def _ensure_setup(self):
        """⚡ Bolt: Lazy-load environment, logging, and regex patterns."""
    ...
    def init_db(self):
        ...
        # ⚡ Bolt: Enable WAL mode and synchronous=NORMAL for high-performance concurrent writes
    ...
    def parse_markdown_files(self) -> List[int]:
        ...
        research_dir_obj = Path(RESEARCH_DIR)
        md_files = list(research_dir_obj.glob("**/*.md"))
        affected_ids = []
    ...
    def cache_verdict(self, action: str, verdict: str):
        ...
        # ⚡ Bolt: log_audit will commit both the verdict and the audit entry in one transaction
