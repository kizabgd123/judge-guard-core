...
class ResearchPipeline:
    ...
    def _ensure_env_loaded(self):
        """⚡ Bolt: Lazy-load environment variables only once."""
    ...
    @property
    def executor(self):
        """⚡ Bolt: Lazy-load ThreadPoolExecutor to reduce startup overhead."""
    ...
    def cache_verdict(self, action: str, verdict: str):
        ...
        # ⚡ Bolt: Removed self.conn.commit() here because log_audit() handles it.
