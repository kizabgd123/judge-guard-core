...
class ResearchPipeline:
    ...
    def parse_markdown_files(self) -> List[int]:
        ...
        for md_path in md_files:
            ...
            # ⚡ Bolt: Use read_bytes() for hashing to avoid redundant UTF-8 decoding for unchanged files
            ...
            # ⚡ Bolt: Only decode UTF-8 for new or modified files
    ...
    def extract_patterns(self, doc_ids: Optional[List[int]] = None):
        ...
        # ⚡ Bolt: Single-pass re.finditer with a compiled regex for O(N) extraction
        # instead of nested findall/search loops.
