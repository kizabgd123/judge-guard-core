...
class ResearchPipeline:
    def __init__(self):
        # ⚡ Bolt: Initialize lock for thread-safe lazy loading
    ...
    def _ensure_setup(self):
        """⚡ Bolt: Lazy-load environment and logging setup."""
    ...
    def sync_to_notion(self):
        ...
        # ⚡ Bolt: Use local os.getenv to avoid module-level global state
