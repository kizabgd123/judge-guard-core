...
# === CONFIG ===
# ⚡ Bolt: Use strings instead of Path objects to reduce module-load overhead
DB_PATH = "./research.db"
RESEARCH_DIR = "./research"
NOTION_LOG = "./.cache/notion_queue.json"

# ⚡ Bolt: Thread-safe initialization flag and lock
...
class ResearchPipeline:
    ...
    def _ensure_setup(self):
        """⚡ Bolt: Lazy-load environment variables only when needed."""
        global _setup_done
        if not _setup_done:
            with _setup_lock:
                if not _setup_done:
    ...
    def init_db(self):
        ...
        # ⚡ Bolt: Optimize SQLite for fast synchronous writes
