...
class ResearchPipeline:
    def __init__(self):
        ...
        self.notion_queue = []
        self._session = None
        # ⚡ Bolt: Lock for thread-safe database operations
    ...
    def cache_verdict(self, action: str, verdict: str):
        ...
        with self._lock:
            ...
            # ⚡ Bolt: Removed redundant self.conn.commit() here because log_audit below
            # will perform a commit by default, reducing total write latency.
