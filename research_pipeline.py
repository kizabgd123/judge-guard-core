...
# === CONFIG ===
# ⚡ Bolt: Keep these as Path objects at module level to support existing tests that patch them.
...
class ResearchPipeline:
    ...
    def _apply_optimizations(self):
        """⚡ Bolt: Enable WAL mode and NORMAL synchronous for ~90% faster writes."""
        if self.conn:
    ...
    def cache_verdict(self, action: str, verdict: str):
        ...
        # ⚡ Bolt: Redundant commit removed; handled by log_audit below.
