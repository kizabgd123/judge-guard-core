...
class ResearchPipeline:
    ...
    def __init__(self):
        # ⚡ Bolt: Thread-safe lazy environment loading once across all instances
    ...
    @property
    def executor(self):
        """⚡ Bolt: Thread-safe lazy-load ThreadPoolExecutor on demand."""
    ...
    def close(self):
        """⚡ Bolt: Ensure ThreadPoolExecutor, Session, and DB connection are cleanly shut down."""
    ...
    def init_db(self):
        ...
        # ⚡ Bolt: Enable check_same_thread=False and WAL mode with synchronous=NORMAL for fast write commits
    ...
    def cache_verdict(self, action: str, verdict: str):
        ...
        # ⚡ Bolt: Populate in-memory cache for fast path lookups
    ...
    def get_cached_verdict(self, action: str) -> Optional[str]:
        ...
        if result:
            ...
            # ⚡ Bolt: Store negative query result in memory cache to bypass SQLite on repeated misses
    ...
    def sync_to_notion(self):
        ...
        try:
            ...
            # ⚡ Bolt: Parallelize Notion API calls using the lazy thread executor
