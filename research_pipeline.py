...
# === CONFIG ===
# ⚡ Bolt: Defer Path and logging setup
DB_PATH = None # For backward compatibility with tests
RESEARCH_DIR = None # For backward compatibility with tests
_NOTION_LOG = None
_LOGGER = None
...
def get_notion_log_path():
    global _NOTION_LOG
    if _NOTION_LOG is None:
        from pathlib import Path
        _NOTION_LOG = Path("./.cache/notion_queue.json")
    return _NOTION_LOG
...
class ResearchPipeline:
    ...
    @property
    def pattern_re(self):
        """⚡ Bolt: Lazy-load pre-compiled regex."""
    ...
    def sync_to_notion(self):
        ...
        notion_log = get_notion_log_path()
