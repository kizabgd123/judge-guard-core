...
class ResearchPipeline:
    def __init__(self):
        self.conn = None
        self.notion_queue = []
        # ⚡ Bolt: Use lazy property for session to defer 'requests' import
        self._session = None
    ...
    @property
    def session(self):
        """⚡ Bolt: Lazy-load requests session."""
    ...
    def close(self):
        ...
        # Check _session specifically to avoid triggering lazy load during shutdown
