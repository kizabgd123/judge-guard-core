...
# ⚡ Bolt: Defer heavy imports to reduce module import time
# import sqlite3
# import hashlib
# import json
# import re
...
# ⚡ Bolt: Use a module-level logger that is lazily configured
import logging
...
# ⚡ Bolt: Pre-compiled regex moved to class or lazily initialized to defer 're' import
_PATTERN_RE = None
...
class ResearchPipeline:
    ...
    def _apply_optimizations(self, conn):
        ...
        # We need sqlite3 in scope for row_factory if we use it, but better use property
        import sqlite3
