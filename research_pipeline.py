...
class ResearchPipeline:
    ...
    def parse_markdown_files(self) -> List[int]:
        ...
        for md_path in md_files:
            ...
            # ⚡ Bolt: Read bytes for hashing to avoid redundant UTF-8 decoding for unchanged files
            ...
            # ⚡ Bolt: Only decode changed/new files
    ...
    def extract_patterns(self, doc_ids: Optional[List[int]] = None):
        ...
        for doc in docs:
            # ⚡ Bolt: Use a single-pass finditer with pre-compiled regex to avoid double-matching overhead
