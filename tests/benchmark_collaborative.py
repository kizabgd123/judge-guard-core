...
# Patch NotionClient AT SOURCE before importing anything that might import it
# Since KaggleAgent uses lazy loading, we must patch the source location
with patch('src.antigravity_core.notion_client.NotionClient') as mock_notion_class:
