...
class GuardianAgent:
    ...
    def process_logs(self):
        ...
        # ⚡ Bolt: Fetch unprocessed logs and active goals concurrently at the start
        # to eliminate sequential Notion API query delays (~1.0s speedup).
        ...
        logger.info(f"Found {len(logs)} new logs. Finalizing goals fetch and Gemini warmup in parallel...")
