...
class GuardianAgent:
    ...
    def _get_title(self, page: Dict) -> str:
        ...
        try:
            ...
            # ⚡ Bolt: Direct O(1) fast-path checks for common Notion title keys
            ...
            # Fallback: scan all properties for any property with id == "title"
            ...
            # Fallback: 'Entry' property if it's Rich Text
