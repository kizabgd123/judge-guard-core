...
function App() {
  ...
  useEffect(() => {
    ...
    // CI Safety: Guard document access for non-browser environments (e.g. Workers)
    const docExists = typeof document !== 'undefined' && document !== null;
    ...
    if (docExists && typeof document.addEventListener === 'function') {
      try {
        document.addEventListener("visibilitychange", handleVisibilityChange);
      } catch (e) {
        console.warn("Failed to add visibilitychange listener", e);
      }
    }
    ...
    return () => {
      ...
      if (docExists && typeof document.removeEventListener === 'function') {
        try {
