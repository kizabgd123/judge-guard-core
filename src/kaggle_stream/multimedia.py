...
class MultimediaManager:
    ...
    def __init__(self, hf_token: Optional[str] = None):
        ...
        # ⚡ Bolt: Lazy session initialization to defer 'requests' import
        self._session = None
    ...
    @property
    def session(self):
        """⚡ Bolt: Thread-safe lazy initialization for the requests session."""
    ...
    def close(self):
        """⚡ Bolt: Cleanup the requests session."""
        if self._session:
            self._session.close()
