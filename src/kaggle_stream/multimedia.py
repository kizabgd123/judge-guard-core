...
# Module-level variable for deferred import binding
requests = None
...
class MultimediaManager:
    ...
    def __init__(self, hf_token: Optional[str] = None):
        ...
        # ⚡ Bolt: Lazy session initialization to defer heavy requests import
        self._session = None
    ...
    @property
    def session(self):
        """⚡ Bolt: Lazy property to defer requests import and Session initialization (thread-safe)."""
