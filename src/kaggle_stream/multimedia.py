...
class MultimediaManager:
    ...
    def __init__(self, hf_token: Optional[str] = None):
        ...
        # ⚡ Bolt: Lazy initialization components
        self._session = None
    ...
    @property
    def session(self):
        """⚡ Bolt: Lazy-load requests and initialize session on demand to reduce module import overhead."""
    ...
    def close(self):
        """⚡ Bolt: Ensure session is cleanly shut down if it was initialized."""
