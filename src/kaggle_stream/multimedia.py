...
class MultimediaManager:
    ...
    def __init__(self, hf_token: Optional[str] = None):
        ...
        # ⚡ Bolt: Lock and holder for lazy session initialization
    ...
    def close(self):
        """⚡ Bolt: Cleanly close session resources."""
    ...
    @property
    def session(self):
        """⚡ Bolt: Lazy property to defer heavy requests import and session initialization (thread-safe)."""
