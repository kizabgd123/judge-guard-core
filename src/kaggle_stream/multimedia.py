...
class MultimediaManager:
    ...
    def __init__(self, hf_token: Optional[str] = None):
        ...
        # ⚡ Bolt: Use requests.Session for connection pooling and better performance (lazy-loaded thread-safely)
        self._session = None
    ...
    @property
    def session(self):
        """⚡ Bolt: Lazy-load requests and initialize session on demand thread-safely."""
