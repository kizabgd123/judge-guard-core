...
class MultimediaManager:
    ...
    def __init__(self, hf_token: Optional[str] = None):
        ...
        # ⚡ Bolt: Use thread-safe lazy property for session to defer heavy requests import
        self._session = None
    ...
    @property
    def session(self):
        """⚡ Bolt: Lazy property to defer requests import and session creation until needed."""
