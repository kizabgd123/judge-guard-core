...
class MultimediaManager:
    ...
    def __init__(self, hf_token: Optional[str] = None):
        ...
        # ⚡ Bolt: Thread-safe lazy initialization for requests.Session to avoid heavy import overhead at module load time
    ...
    @property
    def session(self):
        """⚡ Bolt: Lazy-load requests and initialize session on demand using double-checked locking."""
