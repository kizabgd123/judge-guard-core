...
# ⚡ Bolt: Module-level requests variable for lazy initialization
requests = None
...
class MultimediaManager:
    ...
    def __init__(self, hf_token: Optional[str] = None):
        ...
        # ⚡ Bolt: Lock and private attribute for thread-safe lazy requests.Session initialization
    ...
    @property
    def session(self):
        """⚡ Bolt: Thread-safe lazy initialization of requests and session."""
