...
# ⚡ Bolt: Lazy import holder to defer heavy requests import overhead (~170-220ms)
requests = None
...
class MultimediaManager:
    ...
    def __init__(self, hf_token: Optional[str] = None):
        ...
        # ⚡ Bolt: Defer requests import and Session creation using lazy property + RLock
        self._session = None
    ...
    @property
    def session(self):
        """⚡ Bolt: Thread-safe lazy-load requests and initialize session on demand."""
    ...
    def close(self):
        """⚡ Bolt: Ensure session is cleanly closed on teardown."""
        try:
