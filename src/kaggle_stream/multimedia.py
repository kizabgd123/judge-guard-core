...
class MultimediaManager:
    ...
    def __init__(self, hf_token: Optional[str] = None):
        ...
        # ⚡ Bolt: Initialize thread-safe lock for lazy loading and cache access
        self._lock = threading.RLock()

        # ⚡ Bolt: Lazy-loaded session
        self._session = None
    ...
    def close(self):
        """⚡ Bolt: Ensure requests.Session is cleanly shut down."""
        with self._lock:
    ...
    def generate_audio(self, text: str, output_path: str = "speech.mp3"):
        ...
        try:
            # ⚡ Bolt: Accessing the lazy property 'self.session' handles the import
