...
class MultimediaManager:
    ...
    def __init__(self, hf_token: Optional[str] = None):
        ...
        # ⚡ Bolt: Use a lock for thread-safe lazy initialization and cache access
    ...
    def generate_audio(self, text: str, output_path: str = "speech.mp3"):
        ...
        try:
            # ⚡ Bolt: API calls are typically outside the lock to allow concurrency,
            # but here we use session which is thread-safe.
    ...
    def close(self):
        """⚡ Bolt: Ensure session is cleanly shut down."""
        # ⚡ Bolt: Use a direct attribute check to avoid triggering lazy loading during teardown
