...
def collaborative_step(mode, task):
    ...
    Both Alpha and Beta run with return_futures=True and all four media-generation futures
    resolve concurrently at the end of the step.
    """
    current_task = task
    ...
    # ⚡ Bolt: Run Beta turn with return_futures=True to prevent sequential blocking during multimedia generation
